...
function add_enqueue () {
 ...
 //    wp_register_script('gmaps', 'https://hpneo.github.io/gmaps/gmaps.js?key=AIzaSyAG0vXC-H8BbXePH5tGtSIQwo-lWK0IN4I', array(), false, false );
    ...
    wp_enqueue_script('pagetop_js', get_stylesheet_directory_uri() . '/js/pagetop.js', array('jquery'));
    wp_enqueue_script('nav_fix_js', get_stylesheet_directory_uri() . '/js/nav_fix.js', array('jquery'));
        ...
        if ( is_archive() && !is_tax() && !is_category() && !is_tag() ) {
            ...
            // Else if post is in a custom taxonomy
            	...
            	if($post_type != 'candidate') {
                	...
                	echo '<li class="item-current item-' . $post->ID . '"><span class="bread-current bread-' . $post->ID . '" title="' . get_the_title() . '">候補者詳細ページ </span></li>';
                }
            ...
            if( $post->post_parent ){
                ...
                if($slug == 'candidate-selected' || $slug == 'candidate-history' || $slug == 'search-page') {
	            	echo '<li class="item-cat"><a class="bread-cat" href="' . home_url() . '/my-page">マイページ</a></li>';
	            }   
